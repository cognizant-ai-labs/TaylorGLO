# SOURCE: https://github.com/hongyi-zhang/Fixup/blob/master/cifar/models/fixup_resnet_cifar.py
...
class FixupResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, depth='NOT USED, THIS IS JUST HERE FOR COMPATIBILITY WITH THE RESNET INTERFACE'):
...
def fixup_resnet(**kwargs):
    """
    Constructs a Fixup ResNet model.
    """
    depth = kwargs['depth']
    fn_map = {
        20: fixup_resnet20,
        ...
        56: fixup_resnet56,
        110: fixup_resnet110,
        1202: fixup_resnet1202,
    }
    assert kwargs['depth'] in [20, 32, 44, 56, 110, 1202], 'Unexpected FixupResNet depth!'
    return fn_map[kwargs['depth']](**kwargs)
